            ...
            <div class="logo">
                <a href="<?php echo e(url('/home')); ?>">
                    <div class="d-flex flex-row align-items-center justify-content-start">
                        <div><img src="<?php echo e(asset('images/logo_1.png')); ?>" alt=""></div>
            ...
            <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                ...
                <div class="header_search">
                    <form action="<?php echo e(route('home')); ?>" id="header_search_form" method="get">
                        ...
                        <button type="button" class="header_search_button" value="Search"><img src="<?php echo e(asset('images/search.png')); ?>" alt=""></button>
                    </form>
                </div>
                <?php endif; ?>

                <!-- Cart -->
                <div class="cart"><a href="<?php echo e(url('/cart')); ?>"><div class="wrapper"><img class="svg" src="<?php echo e(asset('images/cart.svg')); ?>" alt="https://www.flaticon.com/authors/freepik"><span>  </span></div></a></div> <!-- class="wrapper" span -->

                <!-- Phone -->
                <div class="header_phone d-flex flex-row align-items-center justify-content-start">
                    <div><div><img src="<?php echo e(asset('images/phone.svg')); ?>" alt="https://www.flaticon.com/authors/freepik"></div></div>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('dashboard')); ?>"> <!-- !!! пока для всех -->
                            <b>Dashboard</b>
                        </a>
                        <?php endif; ?> 
                        ...
                        <div class="col-lg-4 footer_col">
                            <div class="footer_about">
                                <div class="footer_logo">
                                    <a href="<?php echo e(url('/home')); ?>">
                                        <div class="d-flex flex-row align-items-center justify-content-start">
                                            <div class="footer_logo_icon"><img src="<?php echo e(asset('images/logo_2.png')); ?>" alt=""></div>
                                            <div>Little Closet</div>
                                        </div>
                                    </a>        
                                </div>
...
$(document).ready(function(){
   $('.newsletter_button').click(function(){
      BaseRecordForAllPages.mailer($('.newsletter_input.message').val(), $('.newsletter_input.email').val());    
   });  

   BaseRecordForAllPages.cartUserCount();
});
</script>    
