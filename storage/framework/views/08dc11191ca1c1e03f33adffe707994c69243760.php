                                    ...
                                    <li class="cart_item item_list d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-end justify-content-start" style="width: 50%;">
                                        <div class="product d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start mr-auto">
                                            ...
                                            <div><div class="product_image"><img src="<?php echo e(asset('images/' . $cart->product->image)); ?>" alt=""></div></div>
                                            <div class="product_name_container">
                                                <div class="product_name"><a href="#"><?php echo e($cart->product->name); ?></a></div>
                                                <div class="product_text">Second line for additional info</div>
                                            </div>
                                        </div>
                                        <div class="product_price product_text"><?php echo e($cart->product->price); ?></div>
                                    </li>
                                    <hr>
                                   <!-- Cart Item -->
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                        
<?php /**PATH /var/www/html/laravel-products/resources/views/product/cart-standard.blade.php ENDPATH**/ ?>