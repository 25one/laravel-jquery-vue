...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="AdminLTE/css/bootstrap-4.1.2/bootstrap.min.css">
...
<div class="wrapper">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="{{url('/dashboard')}}">
                        <i class="fa fa-folder-o"></i> <span>List of Users</span>
                    </a>
                </li>
            </ul>
        </section>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2023 <a href="#">"25one"</a>.</strong> All rights reserved.
    </footer>
...
<script src="AdminLTE/css/bootstrap-4.1.2/popper.js"></script>
<script src="AdminLTE/css/bootstrap-4.1.2/bootstrap.min.js"></script>
