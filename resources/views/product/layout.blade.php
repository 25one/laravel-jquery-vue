    ...
    <header class="header">
        ...
        <div class="header_content d-flex flex-row align-items-center justify-content-start">
            ...
            <div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
                ...
                <!-- Cart -->
                <div class="cart"><a href="{{ url('/cart') }}"><div class="wrapper"><img class="svg" src="{{ asset('images/cart.svg') }}" alt="https://www.flaticon.com/authors/freepik"><span>  </span></div></a></div> <!-- class="wrapper" span -->
